...
if (!parsedEnv.success) {
  ...
  throw new Error(`❌ ${LOG_CATEGORY_CONFIGURATION} Fatal error: Missing or invalid environment variables. Please check the .env file and ensure all required variables are correctly set.`);
} else {
